...
RUN ls -lt
RUN tar -xf 'node-v18.13.0-linux-x64.tar.xz'
ENV PATH=/downloads/node-v18.13.0-linux-x64/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin
...
ENV PATH=/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/work/node_modules/clean-css-cli/bin:/downloads/node-v18.13.0-linux-x64/bin
COPY package.json .
